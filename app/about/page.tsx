...
// Removed ProtectedRoute import since About should be public
...
const AboutPage: React.FC = () => {
  ...
  return (
    // Removed ProtectedRoute wrapper - About page should be publicly accessible
    <div className="">
      <div>
        {/* Hero Section */}
        <div className="text-center mb-16 space-y-8">
          ...
          <p>
            Slink is a modern, powerful link shortening service designed to help
            individuals and businesses create, manage, and track their links
            with precision and ease. Built with cutting-edge technology for the
            modern web.
          </p>
        </div>
        ...
        <Card className="mb-16 border-0 shadow-lg">
          ...
          <CardContent>
            <p>
              ...
              manageable. Slink empowers users to take control of their digital
              presence by providing intuitive tools that transform simple URL
              shortening into a comprehensive link management platform.
            </p>
            <p>
              Whether you&apos;re a content creator, marketer, developer, or
              business owner, Slink provides the insights and reliability you
              need to optimize your link strategy and connect with your audience
              more effectively.
            </p>
          </CardContent>
        </Card>
